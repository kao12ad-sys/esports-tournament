...
function applyThemeConfig() {
  var cfg = window.SmartConfig || {};
  var theme = cfg.theme === "dark" ? "dark" : "light";
  var dir = cfg.direction === "rtl" ? "rtl" : "ltr";
  var header =
    cfg.headerColor || (theme === "dark" ? "header-dark" : "header-white");
  var logo = cfg.logoColor || (theme === "dark" ? "logo-dark" : "logo-indigo");
  var sidebar =
    cfg.sidebarColor ||
    (theme === "dark" ? "dark-sidebar-color" : "white-sidebar-color");

  document.documentElement.setAttribute("dir", dir);

  // Apply RTL layout class if needed
  if (dir === "rtl") {
    if (document.body) {
      document.body.classList.add("rtl");
      document.body.classList.add("sidemenu-container-reversed");
    }
  } else {
    if (document.body) {
      document.body.classList.remove("rtl");
      document.body.classList.remove("sidemenu-container-reversed");
    }
  }
